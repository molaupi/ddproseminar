...
\definition \defsub{Complement of configuration} Let $c \subseteq \C$ be a configuration. The configuration $\bar{c} = \C \setminus c$ is called the \textbf{complement} of $c$.\\
