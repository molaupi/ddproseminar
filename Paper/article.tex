...
\ddp\ returns a minimal failure-inducing subset of changes as long as the subset is safe, that is they can be applied to the baseline or removed from \td\ without causing an inconsistency. \ddp\ has linear time complexity \cite{Zeller:1999:YMP:318774.318946}.
